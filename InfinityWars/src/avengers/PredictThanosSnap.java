...
public class PredictThanosSnap {
    ...
    public static void main (String[] args) {
        ...
        int[][] arrAdj = new int [nodes][nodes];
        ...
        StdOut.print(isConnected(arrAdj));
    ...
    public static void dfs(int node, int[][] adjacencyMatrix, boolean[] visited) {
        // mark current node as visited
        visited[node] = true;

        // do for every unvisited neighbor of the current node
